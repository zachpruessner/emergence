...
const (
	GameService_Login_FullMethodName = "/packets.GameService/Login"
	GameService_Echo_FullMethodName  = "/packets.GameService/Echo"
)
...
func (c *gameServiceClient) Echo(ctx context.Context, in *EchoRequest, opts ...grpc.CallOption) (*EchoResponse, error) {
	...
	err := c.cc.Invoke(ctx, GameService_Echo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var GameService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "packets.GameService",
